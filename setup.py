...
setup(
    ...
    description='Learning models for psychology and neuroscience.',  # Optional
    ...
    # larger catalog.
    keywords='psychology, neuroscience, learning',  # Optional
    ...
    install_requires=['numpy', 'pandas', 'xarray', 'scipy', 'nlopt', 'plotnine'],  # Optional
